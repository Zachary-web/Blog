<template>
  ...
  <div>
    ...
    <h3 class="ui dividing header">
      Comments | 共 {{ allComment }} 条评论
      <span v-if="closeComment !== 0">（{{ closeComment }} 条评论被隐藏）</span>
    </h3>
    ...
    <div class="comment" v-for="comment in comments" :key="comment.id">
      ...
      <div class="content">
        <a
            class="nickname"
            :href="comment.website && comment.website !== '' ? comment.website : null"
            target="_blank"
      ...
      <div class="comments" v-if="comment.replyComments.length > 0">
        <div class="comment" v-for="reply in comment.replyComments" :key="reply.id">
          ...
          <div class="content">
            <a
                class="nickname"
                :href="reply.website && reply.website !== '' ? reply.website : null"
                target="_blank"
                rel="external nofollow noopener"
            >
              {{ reply.nickname }}
