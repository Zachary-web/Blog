package top.zzh.controller.admin;
...
import top.zzh.annotation.OperationLogger;
import top.zzh.entity.Blog;
import top.zzh.entity.Category;
import top.zzh.entity.Tag;
...
import top.zzh.service.CategoryService;
import top.zzh.service.CommentService;
import top.zzh.service.TagService;
...
public class BlogAdminController {
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody top.zzh.model.dto.Blog blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody top.zzh.model.dto.Blog blog) {
	 ...
	 * @return
	 */
	private Result getResult(top.zzh.model.dto.Blog blog, String type) {
		//验证普通字段
