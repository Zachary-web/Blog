package top.zzh.util.comment;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.context.annotation.DependsOn;
import org.springframework.stereotype.Component;
import top.zzh.config.properties.BlogProperties;
import top.zzh.constant.PageConstants;
...
import top.zzh.util.HashUtils;
import top.zzh.util.IpAddressUtils;
import top.zzh.util.MailUtils;
import top.zzh.util.QQInfoUtils;
import top.zzh.util.StringUtils;
import top.zzh.util.comment.channel.ChannelFactory;
import top.zzh.util.comment.channel.CommentNotifyChannel;
import top.zzh.enums.CommentOpenStateEnum;
import top.zzh.enums.CommentPageEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, top.zzh.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(top.zzh.entity.Comment parentComment, Comment comment) {
