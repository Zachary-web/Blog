package top.zzh.util.quartz;

import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import top.zzh.entity.ScheduleJobLog;
import top.zzh.service.ScheduleJobService;
import top.zzh.util.common.SpringContextUtils;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		top.zzh.entity.ScheduleJob scheduleJob = (top.zzh.entity.ScheduleJob) context.getMergedJobDataMap().get(top.zzh.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
