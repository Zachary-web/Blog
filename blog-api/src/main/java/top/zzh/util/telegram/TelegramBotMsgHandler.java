...
import top.zzh.config.properties.TelegramProperties;
import top.zzh.entity.Comment;
import top.zzh.entity.Moment;
import top.zzh.enums.CommentPageEnum;
import top.zzh.service.CommentService;
import top.zzh.service.MomentService;
import top.zzh.util.comment.CommentUtils;
...
public class TelegramBotMsgHandler {
	...
	private String replyComment(String msgContent) {
		...
		if (splitIndex2 != -1 && msgContent.length() > splitIndex2 + 1) {
			...
			top.zzh.model.dto.Comment comment = new top.zzh.model.dto.Comment();
